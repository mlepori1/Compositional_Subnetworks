...
class MLP(nn.Module):
    def __init__(self, 
        ...
        if self.isL0:
            linear = functools.partial(L0UnstructuredLinear, l0=True, mask_init_value=mask_init_value, ablate_mask=ablate_mask)
        else:
            linear = functools.partial(L0UnstructuredLinear, l0=False)
