...
train_tasks = ['110', '111'] # Train insideness and contact subnets

pretrained_models_dir = "/users/mlepori/scratch/Compositional_Subnetworks/Models/resnet50/InCount_Models"
