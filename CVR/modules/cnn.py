    ...
    def __init__(
        ...
        **kwargs
        ...
        if self.l0_components["backbone"] == False:
            ...
            elif backbone == "resnet50": self.backbone = resnet50(isL0=False, embed_dim=2048)
            elif backbone == "wideresnet50": self.backbone = wide_resnet50_2(isL0=False, embed_dim=2048)
           ...
           # If the pretrained weights path is not None, then load up pretrained weights!
            ...
            elif backbone == "L0resnet50": self.backbone = resnet50(isL0=True, embed_dim=2048, mask_init_value=l0_init, ablate_mask=self.ablate_mask, l0_stages=self.l0_stages)
            elif backbone == "L0wideresnet50": self.backbone = wide_resnet50_2(isL0=True, embed_dim=2048, mask_init_value=l0_init, ablate_mask=self.ablate_mask, l0_stages=self.l0_stages)
